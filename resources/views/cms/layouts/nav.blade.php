    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li  id="li_calendario" class="li-menu">
                    <a id="calendario" class="a-menu"  href="{{ route('cms.calendario') }}"><i class="fas fa-images"></i>
                        <span class="hide-menu">Calendario</span>
                    </a>
                </li>

                    <li  id="li_rutas" class="li-menu">
                        <a id="rutas" class="a-menu"  href="{{ route('cms.rutas') }}"><i class="fas fa-list"></i>
