            ...
            <div class="container">
                <div class="form">
                    <!-- <form method="post" accept-charset="utf-8"
                        ...
                        <h2 class="form-titular titular"><span class="text-highlight">Próximamente República Dominicana
</span> </h2>
                        <p class="form-subtitular subtitular">Estamos terminando los detalles para poder activar rutas
                            con la República Dominicana. Deja tus datos si estás interesado en recibir información
                            cuando abramos.</p>
                            <div class="input email required"><label title="Email" for="email"><span
                                ...
                                maxlength="255">
                                <input  hidden id="pais" type="text" ng-model="progreso.pais" value="República Dominicana">
                        </div>
