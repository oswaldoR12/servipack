<main class="content">
    <div class="block block-2e500778-f561-4ef2-9204-fce8fad52d7d block-heading view-1"
        data-block="2e500778-f561-4ef2-9204-fce8fad52d7d">
        <div class="container">
            <h1 class="titular">Contacto</h1>
        </div>
    </div>
    <div class="block block-b2177e86-6784-477b-ae85-8bfb19a315dc block-templates-servicios-expresos-contacto"
        data-block="b2177e86-6784-477b-ae85-8bfb19a315dc">
            ...
            <div class="container">
                <div class="bloque-contacto-content">
                    ...
                    <div class="bloque-contacto-content-info">
                        <div class="bloque-contacto-content-info-icon"><i class="fa-light fa-envelopes-bulk"></i>
                        </div>
                        ...
                        <div class="bloque-contacto-content-info-response">
                            <div class="bloque-contacto-content-info-response-ciudad">
                                <div class="titular text-highlight" id="info-response-ciudad">Bogotá</div>
                            </div>
                            ...
                            <div class="bloque-contacto-content-info-response-telefono">
                                <div id="info-response-telefono"><a href="tel:+57 3152221182" target="_blank"></a></div>
                            </div>
        ...
        <div id="instalaciones-data" data-pais="CO" data-instalaciones="">
        </div>
    </div>
</main>
