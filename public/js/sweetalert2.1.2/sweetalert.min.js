...
!function(t, e) {
    ...
    const i = {}
      , s = t=>new Promise((e=>{
        ...
        i.restoreFocusTimeout = setTimeout((()=>{
            i.previousActiveElement instanceof HTMLElement ? (i.previousActiveElement.focus(),
            i.previousActiveElement = null) : document.body && document.body.focus(),
            e()
        }
        ), 100),
        window.scrollTo(n, o)
    ...
    t)), {})
      ...
      , R = (t,e,n)=>{
        ...
        e.customClass && e.customClass[n]) {
            if ("string" != typeof e.customClass[n] && !e.customClass[n].forEach)
                return void d("Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "').concat(typeof e.customClass[n], '"'));
            K(t, e.customClass[n])
        }
    }
      , U = (t,e)=>{
      ...
      , Z = (t,e)=>{
        ...
        for (let t = 0; t < n.length; t++) {
            const o = n[t];
            if (o instanceof HTMLElement && _(o, e))
                return o
        }
    }
      , $ = (t,e,n)=>{
      ...
      , ot = function(t) {
        ...
        const n = I();
        n && tt(n) && (e && (n.style.transition = "none",
        n.style.width = "100%"),
        setTimeout((()=>{
      ...
      , at = t=>{
        const e = (()=>{
            const t = w();
            return !!t && (t.remove(),
            Y([document.documentElement, document.body], [a["no-backdrop"], a["toast-shown"], a["has-column"]]),
            !0)
        }
        )();
        if (it())
      ...
      , pt = (t,e)=>{
        const n = j()
          , o = M();
        n && o && (e.showConfirmButton || e.showDenyButton || e.showCancelButton ? J(n) : X(n),
        R(n, e, "actions"),
        function(t, e, n) {
            const o = L()
              , i = O()
            ...
            n.reverseButtons && (n.toast ? (t.insertBefore(s, o),
            t.insertBefore(i, o)) : (t.insertBefore(s, e),
            t.insertBefore(i, e),
            t.insertBefore(o, e)))
        }(n, o, e),
        F(o, e.loaderHtml || ""),
    ...
    const gt = (t,e)=>{
        ...
        function(t, e) {
            if (!e)
                return;
            e in a ? K(t, a[e]) : (d('The "position" parameter is not valid, defaulting to "center"'),
            K(t, a.center))
        }(n, e.position),
        function(t, e) {
            if (!e)
    ...
    const ft = ["input", "file", "range", "select", "radio", "checkbox", "textarea"]
      , bt = t=>{
        if (!t.input)
            return;
        if (!Bt[t.input])
            return void p('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(t.input, '"'));
        const e = At(t.input)
          , n = Bt[t.input](e, t);
        J(e),
      ...
      , Bt = {};
    Bt.text = Bt.email = Bt.password = Bt.number = Bt.tel = Bt.url = (t,e)=>(kt(t, e.inputValue),
    Ct(t, t, e),
    vt(t, e),
    t.type = e.input,
    t),
    Bt.file = (t,e)=>(Ct(t, t, e),
    vt(t, e),
    t),
    Bt.range = (t,e)=>{
    ...
    const Et = (t,e)=>{
      ...
      , Ot = (t,e)=>{
        ...
        e.toast ? (K([document.documentElement, document.body], a["toast-shown"]),
        K(t, a.toast)) : K(t, a.modal),
        R(t, e, "popup"),
      ...
      , Mt = t=>{
        ...
        return K(e, a["progress-step"]),
        F(e, t),
        e
    }
      , jt = t=>{
        const e = document.createElement("li");
        return K(e, a["progress-step-line"]),
      ...
      , Ht = (t,e)=>{
        ...
        ((t,e)=>{
            const n = B();
            n && (Q(n, e.title || e.titleText, "block"),
      ...
      , _t = (t,e,n)=>{
        ...
        "Enter" === e.key ? Rt(e, t) : "Tab" === e.key ? Ut(e) : [...Nt, ...Ft].includes(e.key) ? zt(e.key) : "Escape" === e.key && Wt(e, t, n)))
    }
      , Rt = (t,e)=>{
        if (!h(e.allowEnterKey))
            return;
        const n = U(A(), e.input);
      ...
      , zt = t=>{
        ...
        if (a) {
            for (let t = 0; t < e.children.length; t++) {
                ...
                !a)
                    return;
                if (a instanceof HTMLButtonElement && tt(a))
                    break
            }
      ...
      , Wt = (t,e,n)=>{
        h(e.allowEscapeKey) && (t.preventDefault(),
        n(Dt.esc))
    }
    ;
    var Kt = {
    ...
    let Qt = null;
    const te = t=>{
        null === Qt && (document.body.scrollHeight > window.innerHeight || "scroll" === t) && (Qt = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")),
        document.body.style.paddingRight = "".concat(Qt + (()=>{
            const t = document.createElement("div");
    ...
    ;
    function ee(t, e, n, o) {
        N() ? le(t, o) : (s(n).then((()=>le(t, o))),
        qt(i)),
        Zt ? (e.setAttribute("style", "display:none !important"),
        e.removeAttribute("class"),
        e.innerHTML = "") : e.remove(),
        V() && (null !== Qt && (document.body.style.paddingRight = "".concat(Qt, "px"),
        Qt = null),
        (()=>{
    ...
    function ne(t) {
        ...
        const e = Kt.swalPromiseResolve.get(this)
          , n = oe(this);
        this.isAwaitingPromise ? t.isDismissed || (se(this),
        e(t)) : n && e(t)
    }
    const oe = t=>{
        const e = A();
        if (!e)
            return !1;
        const n = ht.innerParams.get(t);
        if (!n || _(e, n.hideClass.popup))
            return !1;
        Y(e, n.showClass.popup),
        K(e, n.hideClass.popup);
        const o = w();
    ...
    const se = t=>{
      ...
      , ce = (t,e,n,o,s)=>{
        dt && (i.swalCloseEventFinishedCallback = ee.bind(null, t, n, o, s),
        e.addEventListener(dt, (function(t) {
            t.target === e && (i.swalCloseEventFinishedCallback(),
      ...
      , he = (t,e)=>{
        ...
        ;
        f(e.inputOptions) || y(e.inputOptions) ? (ue(L()),
    ...
    const be = t=>{
      ...
      , we = (t,e)=>{
        const n = ht.innerParams.get(t);
        if (!n.input)
            return void p('The "input" parameter is needed to be set when using returnInputValueOn'.concat(u(e)));
        const o = t.getInput()
          , i = ((t,e)=>{
            const n = t.getInput();
            if (!n)
        ...
        n.inputValidator ? ve(t, i, e) : o && !o.checkValidity() ? (t.enableButtons(),
        t.showValidationMessage(n.validationMessage)) : "deny" === e ? Ce(t, i) : Be(t, i)
    }
      , ve = (t,e,n)=>{
        const o = ht.innerParams.get(t);
        t.disableInput();
      ...
      , Be = (t,e)=>{
        const n = ht.innerParams.get(t || void 0);
        if (n.showLoaderOnConfirm && ue(),
        n.preConfirm) {
            t.resetValidationMessage(),
            t.isAwaitingPromise = !0;
            Promise.resolve().then((()=>b(n.preConfirm(e, n.validationMessage)))).then((n=>{
                tt(T()) || !1 === n ? (t.hideLoading(),
                se(t)) : Ae(t, void 0 === n ? e : n)
            }
            )).catch((e=>ke(t || void 0, e)))
        } else
            Ae(t, e)
    ...
    function He(t) {
        ...
        n.customClass && n.customClass.validationMessage && K(e.validationMessage, n.customClass.validationMessage),
    ...
    function Ke(t) {
        ...
        if (!e || _(e, n.hideClass.popup))
            return void d("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
        const o = Ye(t)
          , i = Object.assign({}, n, o);
        Ht(this, i),
    ...
    function Ze() {
        ...
        e ? (t.popup && i.swalCloseEventFinishedCallback && (i.swalCloseEventFinishedCallback(),
        delete i.swalCloseEventFinishedCallback),
    ...
    const $e = t=>{
      ...
      , Je = t=>{
        t.isAwaitingPromise ? (Xe(ht, t),
        t.isAwaitingPromise = !0) : (Xe(Kt, t),
        Xe(ht, t),
    ...
    var pn = Object.freeze({
        ...
        bindClickHandler: function() {
            ...
            ln || (document.body.addEventListener("click", dn),
            ln = !0)
        },
        clickCancel: ()=>{
            var t;
    ...
    const gn = ["swal-title", "swal-html", "swal-footer"]
      ...
      , yn = t=>{
        ...
        return n && (kn(n, ["src", "width", "height", "alt"]),
      ...
      , vn = t=>{
        ...
        n && (kn(n, ["type", "label", "placeholder", "value"]),
      ...
      , Bn = t=>{
        ...
        V() && (Pn(e, t.scrollbarPadding, o),
        Array.from(document.body.children).forEach((t=>{
            t === w() || t.contains(w()) || (t.hasAttribute("aria-hidden") && t.setAttribute("data-previous-aria-hidden", t.getAttribute("aria-hidden") || ""),
      ...
      , En = t=>{
        ...
        if (t.target !== e || !dt)
            return;
        const n = w();
        e.removeEventListener(dt, En),
        n.style.overflowY = "auto"
    }
      , xn = (t,e)=>{
        dt && nt(e) ? (t.style.overflowY = "hidden",
        e.addEventListener(dt, En)) : t.style.overflowY = "auto"
    }
      , Pn = (t,e,n)=>{
        (()=>{
    ...
    function Sn(t) {
        !function(t) {
            t.inputValidator || ("email" === t.input && (t.inputValidator = Ln.email),
    ...
    class jn {
        ...
        _main(t) {
            ...
            i.currentInstance && (i.currentInstance._destroy(),
            V() && Yt()),
            i.currentInstance = On;
            const n = In(t, e);
            Sn(n),
            Object.freeze(n),
            i.timeout && (i.timeout.stop(),
            delete i.timeout),
            clearTimeout(i.restoreFocusTimeout);
            const o = Dn(On);
            return Ht(On, n),
            ht.innerParams.set(On, n),
            Hn(On, o, n)
        }
        then(e) {
    ...
    const Hn = (t,e,n)=>new Promise(((o,s)=>{
        ...
        ((t,e,n)=>{
            qt(t),
            e.toast || (t.keydownHandler = t=>_t(e, t, n),
        ...
        ((t,e)=>{
            "select" === e.input || "radio" === e.input ? he(t, e) : ["text", "email", "number", "tel", "textarea"].some((t=>t === e.input)) && (f(e.inputValue) || y(e.inputValue)) && (ue(L()),
            fe(t, e))
        }
        )(t, n),
        Bn(n),
      ...
      , Nn = (t,e)=>e.focusDeny && tt(t.denyButton) ? (t.denyButton.focus(),
    !0) : e.focusCancel && tt(t.cancelButton) ? (t.cancelButton.focus(),
    !0) : !(!e.focusConfirm || !tt(t.confirmButton)) && (t.confirmButton.focus(),
    !0)
      , Fn = ()=>{
