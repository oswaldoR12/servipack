...
//----Directiva Doctores        
    ...
    .directive('imagenSlider', imagenSlider)
    .directive('sliderView', sliderView)
...
function imagenSlider($compile){
    ...
    return {
                ...
                templateUrl: "./site_media/templates/imagenSlider.html",
...
function sliderView($compile){
    ...
    return {
                ...
                templateUrl: "./site_media/templates/sliderView.html",
                controller:"sliderConfController",
                replace:true
    }
    //--
